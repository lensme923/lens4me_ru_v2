...
?>
	...
	?>
		...
		<?if($OFFERS_IBLOCK_ID){?>
			<tr>
				<td><?echo GetMessage("KDA_IE_SEARCH_OFFERS_WO_PRODUCTS"); ?>: <span id="hint_SEARCH_OFFERS_WO_PRODUCTS"></span><script>BX.hint_replace(BX('hint_SEARCH_OFFERS_WO_PRODUCTS'), '<?echo GetMessage("KDA_IE_SEARCH_OFFERS_WO_PRODUCTS_HINT"); ?>');</script></td>
				<td>
