...
class CKDAExportExcel {
	...
	public function GetSectionsLevelData($arFilter, $arFieldsSections, $arNavParams)
	{
		...
		{
			$arFilter3 = $arFilter2;
			if(array_key_exists('INCLUDE_SUBSECTIONS', $arFilter3)) unset($arFilter3['INCLUDE_SUBSECTIONS']);
			if(array_key_exists('SECTION_ID', $arFilter3)) unset($arFilter3['SECTION_ID']);
