	...
	implements \IEntityMarker
{
	...
	public function delete()
	{
		...
		$event = new Main\Event('sale', "OnBeforeSaleShipmentItemStoreEntityDeleted", array(
				'ENTITY' => $this,
	...
	public function save()
	{
		...
		if ($this->isChanged())
		{
			...
			$event = new Main\Event('sale', 'OnBeforeSaleShipmentItemStoreEntitySaved', array(
					'ENTITY' => $this,
		...
		{
			/** @var Main\Event $event */
			$event = new Main\Event('sale', 'OnSaleShipmentItemStoreEntitySaved', array(
					'ENTITY' => $this,
					'VALUES' => $this->fields->getOriginalValues(),
			));
			$event->send();
