...
$MESS["SALE_CSM_WIZARD_SITEINSTRUCTIONSTEP_DESCR_TEXT"] = "Сайт с CRM должен быть установлен на отдельном домене. Для работы многосайтовости на разных доменах Вам потребуется произвести настройку программного продукта.";
